...
const WebsitesTemplates = () => {
  ...
  return (
    <div className='xl:max-w-[1500px] pt-28 md:max-w-[52rem] lg:max-w-full    w-full  mx-auto flex flex-col items-center justify-center  relative  px-6 md:px-4  lg:px-16'>
        ...
        <img className=' object-contain hidden lg:block absolute z-[0] left-0 top-0 translate-x-[-20%] opacity-70' src={BGGRADIENT} alt='Yellow gradient'/>
         ...
         <div className='mt-6 lg:mt-10'>
            <FancyButton extraClass="" 
             text="Use AI Builder" bgLinear="linear-gradient(0deg, rgba(255, 106, 0, 0.1), rgba(255, 106, 0, 0.1))"
                ...
                conicColor="rgba(255, 221, 0, 0.5)" width={isMobile?"250px":"400px"}
    ...
    <div className='flex flex-col-reverse lg:flex-row justify-between relative lg:items-center w-full gap-10 pt-20 '>
        <div className='flex-1'>
         ...
         <div className='flex-1 z-10'>
            <p className="text-base text-[#616161]   dark:text-[#EDEDED] font-sans ">How-To Resources</p>
            <p className="text-2xl leading-tight lg:text-3xl font-bold  font-sans text-[#130D08] dark:text-[#fff] pt-1 lg:pt-0">Learn Fast, Build Faster </p> 
            <p className="text-lg leading-tight lg:text-xl xl:max-w-4xl    mx-auto font-sans font-medium text-[#616161] dark:text-[#EDEDED] pt-3 lg:pt-2">New to website building? No worries. Our step-by-step video guides, AI prompt tips, and written tutorials are here to walk you through every feature — from your first click to final launch. </p>
            <ul className='text-lg  list-disc pl-7 pt-6 lg:pt-10 font-sans font-medium text-[#130D08] dark:text-[#FFFFFF]'>
...
const DescribeYourWebsite=()=>{
    const isMobile = useIsMobile();
    return (
    <div className='flex flex-col lg:flex-row bg-[#FF6A001A] rounded-[16px] lg:rounded-[30px] justify-between relative lg:items-center w-full gap-10 mt-20 p-6 lg:p-0 lg:pt-10 lg:pl-10'>
         <div className='flex-1 z-10'>
            ...
            <FancyButton extraClass="" 
             text="Generate Website" bgLinear="linear-gradient(0deg, rgba(255, 106, 0, 0.1), rgba(255, 106, 0, 0.1))"
                bgRadial="radial-gradient(50% 50% at 50% 50%, #FF6A00 0%, #FF6A00 100%)" textColor="#fff"
                conicColor="rgba(255, 221, 0, 0.5)" width={isMobile?"200px":"280px"}
                height="55px" borderRadius="50px" animationSpeed="5s" onClick={() => alert("Clicked!")}/>
         </div>
        </div>
        <div className='flex-1'>
