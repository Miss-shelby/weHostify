...
import { africanBusinessfaqData, studentfaqData } from "../../../../data";

const AfricanBusinessFaq = () => {
  ...
  return (
    <div className="relative">
        ...
        <div className="absolute overflow-hidden  lg:hidden top-[60%] lg:top-[370px] right-0   z-0 pointer-events-none opacity-55 block ">
          <img src={GLOW} alt="glow"className=" object-cover lg:w-[500px] lg:h-[644px] translate-x-[20%] -translate-y-[20%]  h-full left-0 w-[350px]  "/>
        </div>
        <div className='xl:max-w-[1500px]   mx-auto flex flex-col items-center justify-center pt-20 lg:pt-20 relative  px-6 lg:px-16'>
            <div
            ...
            className="md:max-w-[790px] w-full mx-auto">
                ...
                <p className="text-2xl leading-tight lg:text-[32px] font-bold font-sans text-[#130D08] dark:text-[#fff] pt-1 lg:pt-2 text-center">Clear Answers for Growing African Brands</p>
                <p className="text-lg leading-tight sm:text-xl   font-sans font-medium text-[#616161] dark:text-[#EDEDED] pt-3 lg:pt-[10px] text-center">We’ve gathered the most common questions we receive from African business owners so you can move forward with confidence.</p>
            </div>
            <div className="w-full mt-6 lg:mt-14 space-y-4 relative">
              {africanBusinessfaqData.map((faq, index) => (
                  <motion.div
                    initial={{ y: 48, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ ease: "easeInOut", duration: 0.75 }}
...
export default AfricanBusinessFaq
