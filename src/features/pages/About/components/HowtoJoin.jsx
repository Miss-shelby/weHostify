  ...
  return (
    <div className='xl:max-w-[1500px] lg:max-w-full md:max-w-[52rem]  mx-auto flex flex-col items-center justify-center pt-20 lg:pt-20  relative  px-6 md:px-4 lg:px-16'>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-7 items-stretch h-full w-full  mt-6 lg:mt-10">
            <div className="flex flex-col card_one overflow-hidden cursor-pointer  
            w-full pt-5 dark:bg-[#18183A] bg-[#FFFFFF] rounded-[30px]">
               ...
               <img className="w-full lg:pt-6 pt-4 h-full object-cover block " src={CLOUDCOMPUTINGONE} alt="cloud-computing-server-digital-data-storage-network-infrastructure"/>
            </div>
            <div className="">
                <div className="flex flex-col z-10 relative overflow-hidden card_two cursor-pointer 
                  bg-[#FF6A004D] rounded-[30px]">
                 ...
                 <div className="flex flex-col mt-6 dark:bg-[#18183A] card_three  cursor-pointer  bg-[#FFF] rounded-[30px]">
             ...
             <div className="flex flex-col  dark:bg-[#18183A] card_four cursor-pointer bg-[#FFF] rounded-[30px]">
