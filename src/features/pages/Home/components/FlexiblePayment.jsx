  ...
  return (
    <div className="relative">
        <div className='xl:max-w-[1500px]  mx-auto flex flex-col items-center justify-center pt-32 relative pb-10 px-6 lg:px-16'>
            {/* <img className=' object-contain absolute z-[0] right-0 top-0 opacity-45' src={BGGRADIENT} alt='Yellow gardient'/> */}
            <div className="w-full z-20">
                ...
                <div className="">
                    ...
                    <div className="hidden xl:grid grid-cols-[378px_520px_378px]  gap-7 mt-20">
                        <div className="bg-[#019CDE] min-h-[300px]  rounded-[24px] flex flex-col justify-center items-center">
                         ...
                         <div className="bg-[#FBB033] min-h-[300px] relative px-[48px] rounded-[24px] flex flex-col justify-center items-center">
                        ...
                        <div className="bg-[#011B33] min-h-[300px]  rounded-[24px] flex flex-col justify-center items-center">
                            <div className="">
                                <Icons.paypal/>
                            </div>
                     ...
                     <div className="grid xl:hidden grid-cols-1 sm:grid-cols-2  gap-7 mt-20">
                         <div className="bg-[#FBB033] col-span-1 sm:col-span-2 min-h-[266px] sm:min-h-[300px] relative px-[48px] rounded-[24px] flex flex-col justify-center items-center">
                            <div className="h-full">
                        ...
                        <div className="bg-[#019CDE] py-10  rounded-[24px] flex flex-col justify-center items-center">
                            ...
                            <p className='font-light text-[#FFFFFF] text-xs text-center font-sans'>Make credit card payment <span className='block'></span>using PayPal</p>
                        </div>
