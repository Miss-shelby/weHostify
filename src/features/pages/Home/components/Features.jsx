...
const Features = () => {
  return (
    ...
    <div className='xl:max-w-[1500px] overflow-hidden lg:max-w-full md:max-w-3xl   mx-auto flex flex-col items-center justify-center pt-20 lg:pt-28  relative  px-6 lg:px-16'>
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between w-full ">
            ...
            className="xl:max-w-lg w-full pb-6 xl:pb-0">
             ...
             <img className=' object-contain lg:hidden absolute z-[0] right-0 top-52 opacity-40' 
        ...
        className="absolute   md:hidden  bottom-[-100px] h-[300px]
         w-[300px] z-0 transform opacity-55   object-cover   left-1/2"/>
    </div>
  )
}
