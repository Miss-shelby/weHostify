  ...
  return (
    <div className="relative">
        <div className='xl:max-w-[1500px]  mx-auto flex flex-col items-center justify-center pt-32 relative pb-10 px-6 lg:px-16'>
             <img className=' object-contain absolute z-[0] left-1/2 transform -translate-x-1/2 top-44' src={BGGRADIENT} alt='Yellow gardient'/>
            <div className="w-full z-20">
                ...
                <div className="">
                    <p className="text-base sm:text-xl lg:max-w-3xl mx-auto font-sans font-medium text-[#616161] dark:text-[#EDEDED] pt-2 text-center">Our referral program lets you earn discounts, cash, or free hosting time 
                  ...
                  <div className="grid lg:grid-cols-5 mt-10">
