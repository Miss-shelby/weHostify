...
const HostingAgents = () => {
  return (
    <div className='xl:max-w-[1500px]  mx-auto flex flex-col items-center justify-center pt-10 lg:pt-32 relative pb-10 px-6 2xl:px-16'>
        <img className=' object-contain hidden lg:block absolute z-[0] top-0 opacity-45' src={BGGRADIENT} alt='Yellow gardient'/>
        <div className="w-full z-20">
            ...
            <div className="flex flex-col xl:flex-row w-full justify-between pt-10 items-start ">
