...
import useScreenFlags from '../hooks/ScreenFlag';
import { GLOW } from '../../../../../constants/assetexports';

const HostingAgentCard = () => {
    const { isXs, isSm, isMd, isLg } = useScreenFlags();
  return (
    <>
    <div className='hidden md:block'>
    <div className='flex flex-col mt-6 2xl:mt-0 md:flex-row gap-8 items-center w-full'>
        <div className="">
        <FancyClipCard number="01"
            title="Personal Agent"
            description="Get 24/7 direct and uninterrupted access to your personal agent"
        ...
        <div className="">
            ...
            number="02"
            title="No Tickets"
            description="No more endless ticket queues. Receive real-time support"
    ...
    <div className='flex gap-8 mt-10 items-center w-full'>
        <div className="relative">
         <FancyClipCard number=""
            title="Get Help"
            description="We offer personalized help and guidance based on your setup"
        ...
        <FancyClipCard number="04"
            title="Be a Boss"
            description="Make decisions like a boss. Chat, call, or message, your choice"
            clipPath="M164.404 26.9795C164.404 41.8799 176.483 53.959 191.384 53.959H332.595C347.73 53.959 360 66.2285 360 81.3638V253.595C360 268.73 347.73 281 332.595 281H27.4048C12.2695 281 0 268.73 0 253.595V27.4048C0 12.2696 12.2696 0 27.4048 0H137.425C152.325 0 164.404 12.0791 164.404 26.9795V26.9795Z"/>
        </div>
    </div>
    </div>
...
export default HostingAgentCard
