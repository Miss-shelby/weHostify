    ...
    <div className="relative">
      <div className="xl:max-w-[1500px] mx-auto flex flex-col items-center justify-center pt-64 sm:pt-24 lg:mt-28 px-6 lg:px-14">
        ...
        <div className="absolute bottom-0 lg:w-[800px] lg:h-[800px]  lg:left-0   z-0 pointer-events-none opacity-45    ">
          ...
          <p className="text-base sm:text-xl font-sans  font-medium text-[#616161] dark:text-[#EDEDED] sm:pt-3 text-center">WeHostify has a plan built just for you. Enjoy fast, secure hosting with  <span className="lg:block">unmatched local support.</span></p>
          <div className="grid lg:grid-cols-3 md:px-10 lg:px-0 w-full gap-6 mt-6 sm:mt-10">
            {
