  ...
  return (
    <div className={`relative card-wrapper w-full ${extraClass}`}style={cardStyleVars}>
      ...
      <div className="card-inner dark:bg-[#18183A]">
        ...
        <h3 className="text-[#130D08] dark:text-[#FFFFFF] font-semibold text-2xl md:text-3xl font-sans mt-1 lg:mt-6">
          {title}
        </h3>
        <p className="font-medium text-[#616161] dark:text-[#EDEDED] font-sans text-lg md:text-xl pt-2">
          {description}
        </p>
      </div>
    </div>
    ...
    <div className="relative wrapper w-full">
      <div className={`card-wrapper w-full ${extraClass}`}style={cardStyleVars}>
        ...
        <div className="card-inner flex flex-col dark:bg-[#18183A]">
          <h3 className="text-[#130D08] dark:text-[#FFFFFF]  font-semibold text-2xl md:text-3xl  font-sans ">{title}</h3>
          <p className="font-medium text-[#616161] dark:text-[#EDEDED]  font-sans text-lg md:text-xl pt-2">{description}</p>
          <p className="text-[#FF6A00] mt-6 lg:mt-20 font-semibold font-sans text-3xl lg:text-[41px] ">
            {number}
          </p>
        </div>
      </div>
