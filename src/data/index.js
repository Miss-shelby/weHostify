import { AFRICANWOMAN, BGONE, BTCGIRL, CAROUSELBG2, CAROUSELBG3, CAROUSELBG4, CAROUSELIMAGE1, CAROUSELIMAGE2, CAROUSELIMAGE3, CAROUSELIMAGE4, CAROUSELIMAGE5, DISCOUNTIMAGE1, DISCOUNTIMAGE2, DISCOUNTIMAGE3, DISCOUNTIMAGE4, DISCOUNTIMAGE5, IMAGEONE, IMAGETWO, LIGHTING, MIGRATION, PROFILEIMG, SECURE, SUPPORT } from "../constants/assetexports";
...
export const slides = [
  {
    ...
    bg: BGONE,
    title: "Nawe Schools",
    description: "Where creativity meets code. Nawe empowers young African developers and designers to build the future through hands-on mentorship, community, and real-world projects.",
    thumb: CAROUSELIMAGE1,
